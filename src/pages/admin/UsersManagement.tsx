...
export default function UsersManagement() {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        const rolesResponse = await api.get("/api/admin/user-roles");
  ...
  const handleAddRole = async (userId: string, role: string) => {
    ...
    try {
      await api.post("/api/admin/user-roles", { user_id: userId, role: role as AppRole });
  ...
  const handleRemoveRole = async (userId: string, role: string) => {
    ...
    try {
      await api.delete("/api/admin/user-roles", { params: { userId, role: role as AppRole } });
