...
const Sales = () => {
  ...
  useEffect(() => {
    const fetchProperties = async () => {
      try {
        const { data } = await api.get('/api/properties?listing_type=sale&status=available');
        ...
        <div className="container mx-auto px-4">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground text-lg mb-6">
              Find your dream property from our curated selection of homes and commercial spaces.
            </p>
          ...
          <PropertyFilters filters={filters} onFiltersChange={setFilters} listingType="sale" />
          <div className="mb-4">
